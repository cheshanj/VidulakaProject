...
public class Ord_Procedure {
    ...
    public boolean ordstatus(int oid, String pid, String q) {
                       ...
                       /* if (or.ord_btnInsert.isEnabled()) {
                          ...
                          /*  try {
                            ...
                            try { System.out.println(tot[k]);
                                String sql5 = "update assign_raw_material set amount='" + tot[k] + "' where orderID='" + oid + "'  ";
